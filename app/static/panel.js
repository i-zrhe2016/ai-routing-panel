(function(vue) {
  ...
  const CoreMixin = {
    ...
    computed: {
      attentionPortCount() {
        return Number(this.summary.expired_ports || 0) + Number(this.summary.quota_ports || 0) + Number(this.summary.disabled_ports || 0);
      },
      totalTrafficBytes() {
    ...
    methods: {
      applyDashboard(dashboard) {
        ...
        this.dataPlaneStatus = ((_a = dashboard.meta) == null ? void 0 : _a.data_plane_status) || {};
        this.aiRoutingStatus = ((_b = dashboard.meta) == null ? void 0 : _b.ai_routing_status) || {};
        this.dnsFailoverStatus = ((_c = dashboard.meta) == null ? void 0 : _c.dns_failover_status) || {};
        this.flash = dashboard.flash || { message: "", level: "info" };
        this.ports = (dashboard.ports || []).map((port) => this.preparePort(port));
        this.commerceSummary = ((_d = dashboard.commerce) == null ? void 0 : _d.summary) || {};
        this.commerceSettings = { ...((_e = dashboard.commerce) == null ? void 0 : _e.settings) || {} };
        this.plans = (((_f = dashboard.commerce) == null ? void 0 : _f.plans) || []).map((plan) => this.preparePlan(plan));
        this.orders = (((_g = dashboard.commerce) == null ? void 0 : _g.orders) || []).map((order) => this.prepareOrder(order));
      },
      clearFlash() {
      ...
      async requestJson(url, options = {}) {
        ...
        if (method !== "GET" && ((_a = this.meta) == null ? void 0 : _a.csrf_token)) {
  ...
  function mountPanelApp() {
    ...
    vue.createApp(createPanelApp(window.__PANEL_STATE__)).mount(root);
  }
